...
if __name__ == "__main__":
    ...
    linkbot.smoothMoveToNB(1, 100, 100, 100, 360)
    linkbot.smoothMoveToNB(2, 100, 100, 100, 360)
    linkbot.smoothMoveToNB(3, 100, 100, 100, 360)
    while linkbot.isMoving():
        print linkbot.getJointSpeeds()
    #linkbot.moveWait()
